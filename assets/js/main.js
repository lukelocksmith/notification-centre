(function () {
    'use strict';
    // Silent version marker — lets us confirm from the console which main.js a
    // (returning) browser is actually running, to diagnose stale-cache issues.
    try { window.NC_VERSION = ncData.version; } catch (e) {}
